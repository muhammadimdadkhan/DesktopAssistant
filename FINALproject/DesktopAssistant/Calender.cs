...
namespace DesktopAssistant
{
    public class Calender
    {
            ...
            try
            {
                ...
                if (calenderItems != null)
                {
                    ...
                    foreach (AppointmentItem appointment in calenderItems)
                    {
                        ...
                        Thread sayAppointment = new Thread(new ThreadStart(() => IT.sayAppointment(appointmentContent)));
        ...
        {
            Thread noAppointment = new Thread(new ThreadStart(() => IT.sayAppointmentError()));
